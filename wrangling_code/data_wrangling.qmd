...
After the data frames are pulled, the code below saves them into the RData file "all_years_untidy.RData", where they will be much quicker to retrieve from the hard drive.
