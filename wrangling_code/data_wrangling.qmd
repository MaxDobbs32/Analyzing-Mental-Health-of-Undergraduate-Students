...
save(
  ...
  year_2023_2024, 
  year_2024_2025,
  file = "../final_wrangled_data/data.RData")
```
...
# Load the files
load(file = "../final_wrangled_data/data.RData")
```
...
degrees <- c("degree_ass", "degree_bach", "degree_ma", "degree_jd", "degree_md", "degree_phd")
...
save(allyears, file = "../final_wrangled_data/allyears.RData")
```
...
load(file = "../final_wrangled_data/allyears.RData")
```
...
saveRDS(avg_adjust_aca_undergrad, "../final_wrangled_data/avg_adjust_aca_undergrad.rds")
saveRDS(avg_adjust_aca_assoc, "../final_wrangled_data/avg_adjust_aca_assoc.rds")
saveRDS(avg_adjust_aca_bach, "../final_wrangled_data/avg_adjust_aca_bach.rds")
```
...
# save as RDS files
saveRDS(combinedgeo, file = "../final_wrangled_data/combinedgeo.rds")
saveRDS(combinedr1_ease, file = "../final_wrangled_data/combinedr1_ease.rds")
saveRDS(combinedr2_ease, file = "../final_wrangled_data/combinedr2_ease.rds")
saveRDS(combinedr3_ease, file = "../final_wrangled_data/combinedr3_ease.rds")
saveRDS(combinedr4_ease, file = "../final_wrangled_data/combinedr4_ease.rds")
saveRDS(combinedr5_ease, file = "../final_wrangled_data/combinedr5_ease.rds")
saveRDS(combinedr6_ease, file = "../final_wrangled_data/combinedr6_ease.rds")
saveRDS(combinedr7_ease, file = "../final_wrangled_data/combinedr7_ease.rds")
saveRDS(combinedr8_ease, file = "../final_wrangled_data/combinedr8_ease.rds")
saveRDS(combinedr9_ease, file = "../final_wrangled_data/combinedr9_ease.rds")
saveRDS(combinedr1_anx, file = "../final_wrangled_data/combinedr1_anx.rds")
saveRDS(combinedr2_anx, file = "../final_wrangled_data/combinedr2_anx.rds")
saveRDS(combinedr3_anx, file = "../final_wrangled_data/combinedr3_anx.rds")
saveRDS(combinedr4_anx, file = "../final_wrangled_data/combinedr4_anx.rds")
saveRDS(combinedr5_anx, file = "../final_wrangled_data/combinedr5_anx.rds")
saveRDS(combinedr6_anx, file = "../final_wrangled_data/combinedr6_anx.rds")
saveRDS(combinedr7_anx, file = "../final_wrangled_data/combinedr7_anx.rds")
saveRDS(combinedr8_anx, file = "../final_wrangled_data/combinedr8_anx.rds")
saveRDS(combinedr9_anx, file = "../final_wrangled_data/combinedr9_anx.rds")
saveRDS(combinedr1_dep, file = "../final_wrangled_data/combinedr1_dep.rds")
saveRDS(combinedr2_dep, file = "../final_wrangled_data/combinedr2_dep.rds")
saveRDS(combinedr3_dep, file = "../final_wrangled_data/combinedr3_dep.rds")
saveRDS(combinedr4_dep, file = "../final_wrangled_data/combinedr4_dep.rds")
saveRDS(combinedr5_dep, file = "../final_wrangled_data/combinedr5_dep.rds")
saveRDS(combinedr6_dep, file = "../final_wrangled_data/combinedr6_dep.rds")
saveRDS(combinedr7_dep, file = "../final_wrangled_data/combinedr7_dep.rds")
saveRDS(combinedr8_dep, file = "../final_wrangled_data/combinedr8_dep.rds")
saveRDS(combinedr9_dep, file = "../final_wrangled_data/combinedr9_dep.rds")
